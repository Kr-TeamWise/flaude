...
const translations = {
  ...
  // Meeting
  "nav.meetings": { ko: "회의", en: "Meetings" },
  "meeting.title": { ko: "회의", en: "Meetings" },
  "meeting.create": { ko: "새 회의", en: "New Meeting" },
  "meeting.upload": { ko: "업로드", en: "Upload" },
  "meeting.import": { ko: "임포트", en: "Import" },
  "meeting.record": { ko: "녹음 시작", en: "Start Recording" },
  "meeting.recordStop": { ko: "녹음 중지", en: "Stop Recording" },
  "meeting.recording": { ko: "녹음 중", en: "Recording" },
  "meeting.transcribing": { ko: "전사 중...", en: "Transcribing..." },
  "meeting.completed": { ko: "완료", en: "Completed" },
  "meeting.failed": { ko: "실패", en: "Failed" },
  "meeting.uploaded": { ko: "업로드됨", en: "Uploaded" },
  "meeting.transcript": { ko: "전사본", en: "Transcript" },
  "meeting.edit": { ko: "편집", en: "Edit" },
  "meeting.copy": { ko: "복사", en: "Copy" },
  "meeting.save": { ko: "저장", en: "Save" },
  "meeting.cancel": { ko: "취소", en: "Cancel" },
  "meeting.process": { ko: "처리 시작", en: "Process" },
  "meeting.processing": { ko: "처리 중...", en: "Processing..." },
  "meeting.results": { ko: "결과", en: "Results" },
  "meeting.selectAgent": { ko: "에이전트 선택", en: "Select Agent" },
  "meeting.summary": { ko: "요약", en: "Summary" },
  "meeting.actionItems": { ko: "액션 아이템", en: "Action Items" },
  "meeting.followUp": { ko: "팔로업 메일", en: "Follow-up Email" },
  "meeting.proposal": { ko: "제안서", en: "Proposal" },
  "meeting.custom": { ko: "커스텀", en: "Custom" },
  "meeting.noMeetings": { ko: "아직 회의 기록이 없습니다.", en: "No meetings yet." },
  "meeting.participants": { ko: "참석자", en: "Participants" },
  "meeting.duration": { ko: "소요 시간", en: "Duration" },
  "meeting.retranscribe": { ko: "다시 전사", en: "Re-transcribe" },
  "meeting.noTranscript": { ko: "전사본이 없습니다.", en: "No transcript available." },
  "meeting.agentProcessing": { ko: "에이전트 처리", en: "Agent Processing" },
  "meeting.noResults": { ko: "아직 처리 결과가 없습니다.", en: "No results yet." },
  "meeting.date": { ko: "날짜", en: "Date" },
  "meeting.model": { ko: "모델", en: "Model" },
  "meeting.source": { ko: "소스", en: "Source" },
  "meeting.notes": { ko: "메모", en: "Notes" },
  "meeting.client": { ko: "고객", en: "Client" },
  "meeting.delete": { ko: "삭제", en: "Delete" },
  "meeting.confirmDelete": { ko: "이 회의를 삭제할까요?", en: "Delete this meeting?" },
  "meeting.minutes": { ko: "분", en: "min" },

  // Meeting Settings
  "settings.meeting": { ko: "회의", en: "Meeting" },
  "settings.meetingEnabled": { ko: "회의 기록 기능", en: "Meeting Recording" },
  "settings.meetingEnabledDesc": { ko: "활성화하면 사이드바에 회의 탭이 표시됩니다.", en: "Enable to show the Meetings tab in the sidebar." },
  "settings.meetingDeps": { ko: "의존성 설치", en: "Dependencies" },
  "settings.meetingModels": { ko: "음성 모델", en: "Speech Models" },
  "settings.meetingModelDownload": { ko: "다운로드", en: "Download" },
  "settings.meetingModelDownloading": { ko: "다운로드 중...", en: "Downloading..." },
  "settings.meetingModelActive": { ko: "사용 중", en: "Active" },
  "settings.meetingLanguage": { ko: "기본 언어", en: "Default Language" },
  "settings.meetingAutoDelete": { ko: "전사 완료 후 오디오 삭제", en: "Delete audio after transcription" },
  "settings.meetingInstalled": { ko: "설치됨", en: "Installed" },
  "settings.meetingNotInstalled": { ko: "미설치", en: "Not installed" },
  "settings.meetingInstall": { ko: "설치", en: "Install" },
  "settings.meetingInstalling": { ko: "설치 중...", en: "Installing..." },
  "settings.meetingAudioSource": { ko: "오디오 소스", en: "Audio Source" },
  "settings.meetingSystemAudio": { ko: "시스템 오디오", en: "System Audio" },
  "settings.meetingMicrophone": { ko: "마이크", en: "Microphone" },
  "settings.meetingShortcut": { ko: "단축키", en: "Shortcut" },
  "settings.meetingMaxDuration": { ko: "최대 녹음 시간", en: "Max Recording Duration" },
  "settings.meetingSilenceAlert": { ko: "무음 5분 시 알림", en: "Alert on 5min silence" },
  "settings.meetingRecording": { ko: "녹음 설정", en: "Recording Settings" },
  "settings.meetingBlackholeGuide": { ko: "시스템 오디오 캡처는 화면 녹화 권한이 필요합니다.", en: "System audio capture requires Screen Recording permission." },
  "settings.meetingSetupGuide": { ko: "설정 가이드 보기", en: "View Setup Guide" },
} as const;
